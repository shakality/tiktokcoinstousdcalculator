...
const Terms: React.FC = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      <Helmet>
        <title>TikTok Coins // Terms_Of_Service</title>
        <meta name="description" content="Operational guidelines and terms of service for the TikTok Coins environment." />
      </Helmet>
      ...
      <div className="bg-white p-10 md:p-16 razor-card border border-ink/10 prose prose-neutral max-w-none font-mono text-sm text-ink/60">
        ...
        <section className="mb-12">
          ...
          <p>
            By accessing TikTok Coins, you agree to be bound by these terms. System usage is subject to all posted guidelines.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p>
            TikTok Coins provides a precision calculator tool for virtual asset estimation. Service is provided "AS IS" for informational purposes.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p>
            TikTok Coins is an independent environment and is not affiliated with TikTok, ByteDance, or any subsidiaries.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p>
            All content and functionality are the property of TikTok Coins and are protected by international law.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            In no event shall TikTok Coins be liable for damages arising out of the use or inability to use the materials provided.
          </p>
        </section>
      </div>
    </div>
